...
#pragma config(Sensor, dgtl8,  ouncherStop,    sensorTouch)
#pragma config(Sensor, dgtl9,  rightEncoder,   sensorQuadEncoder)
#pragma config(Sensor, dgtl11, rightSonic,     sensorSONAR_inch)
#pragma config(Motor,  port1,           rightFrontMotor, tmotorVex393_HBridge, openLoop, driveRight)
#pragma config(Motor,  port2,           leftFrontMotor, tmotorVex393_MC29, openLoop, reversed, driveRight)
#pragma config(Motor,  port3,           frontWheelLify, tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port4,           intakeMotor,   tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port5,           rollerMotor,   tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port6,           intakeBottomMotor, tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port7,           capFlipper,    tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port8,           puncherMotor,  tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port9,           leftRearMotor, tmotorVex393_MC29, openLoop, driveLeft)
#pragma config(Motor,  port10,          rightRearMotor, tmotorVex393_HBridge, openLoop, driveLeft)
